...
- **J271_한민수**
    ...
    - 수행 내용
        - 수분 보충하기💦
            ...
            - 8월 8일
        - 하루하루 작은 성공 기록하기✍️
            - 8월 5일: 지난 주 mit 프로그램 구현 때와 달리, 오늘은 반복되는 로직을 어느 정도 미리 모듈화하면서 프로그램을 구현하였다
            - 8월 6일: 다양한 관점에서 어제 미션에서 개선할 점을 찾아보고 실행에 옮겼다
            - 8월 7일: 짝과 함께 2시가 되기 전에 미션의 모든 요구사항을 구현했다
            - 8월 8일: 개선하기 시간에 700줄이었던 코드를 리팩토링해서 450줄로 줄였다!
            
- **S048_이명진**
    - 선택한 퀘스트
        - 최소 취침 시간 채우기💤
        - 집 말고 밖에서 30분 활동 하자~💭 ✅ : 매일 아침 마다 러닝 하면서 해당 퀘스트를 완료 하였습니다.
    - 수행 내용
      - 최소 취침 시간 채우기💤
         - 8월 5일 ✅
         - 8월 6일 ✅
...
- **J226_정유찬**
    1. **집 말고 밖에서 30분 활동 하자~💭**
         - 8월 5일 ✅ : 밤 산책으로 환기~
         - 8월 6일 ✅ : 미션을 마친 후 헬스장 다녀오기 완료!
         - 8월 7일 ✅ : 도서관까지 걸어가기
         - 8월 8일 ✅ : 밤 산책으로 생각 정리!

- **J232_정한힘**
    1. **집 말고 밖에서 30분 활동 하자~💭**
        - 하루 30분 산책을 매일 하는게 목표입니다.
        - 퀘스트도 수행하면서 산책하려고 합니다.
    
- **K011_김정현**
    - **선택한 퀘스트 : 리프레시 타임 가지기🌱**
        - 🤯 **리프레시 타임이 없다면 머리가 터져버릴거같아요.**
    - **내가 가진 리프레시 타임 기록🌱**
